...
from physics_solver.the_types.variable_change import VariableChange
...
class RelativeChangeProblem(Problem):
    ...
    def solve_and_make_string_solution(self) -> StringSolution:
        ...
        first_subs = formula.expansion.subs([(c.variable, Symbol(str(c.variable) + '_1')) for c in self.changes])
